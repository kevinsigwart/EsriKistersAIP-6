...
{	
	...
	.append("svg:title").text(function(d) {
		return (d3formatDate(new Date(d.attributes[timeField]),'MMMM yyyy')); //(new Date(d.attributes[timeField])).toDateString();
	}); 
...
function changeEventStep()
{
    ...
    var datePattern = 'MMMM yyyy';
  	var dateString =d3formatDate(currentDateTime,datePattern);
  	 	
	timeSliderDateLabel = dateString; 
 ...
 * 
 * @param {Object} date
 * @param {Object} datePattern
 */
function d3formatDate(date,datePattern){
